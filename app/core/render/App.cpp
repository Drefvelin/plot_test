...
#include "util/MemoryReport.h"
#include "util/Profile.h"
#include "placement/terrain/TerrainPlacement.h"
#include "generation/TownBuilder.h"
...
void App::buildDiagram() {
    ...
    diagramTexture_.clear(yamlutil::toSfColor(config_.colors.outside));
    ...
    circle.setFillColor(yamlutil::toSfColor(config_.colors.inside));
...
void App::drawRoadLabels() {
    ...
    for (const Road& road : town_.roads) {
        ...
        idText.setFillColor(road.isBridge ? yamlutil::toSfColor(config_.colors.bridge)
                                          : sf::Color::Black);
        ...
        box.setOutlineColor(road.isBridge ? yamlutil::toSfColor(config_.colors.bridge)
                                          : sf::Color::Black);
...
int App::run() {
    ...
    const sf::Color background = yamlutil::toSfColor(config_.colors.outside);
